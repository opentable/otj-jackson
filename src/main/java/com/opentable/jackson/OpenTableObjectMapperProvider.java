 ...
 */
class OpenTableObjectMapperProvider implements Provider<ObjectMapper>
{
    ...
    @Inject
    OpenTableObjectMapperProvider()
    {
        this(null);
    }

    OpenTableObjectMapperProvider(final JsonFactory jsonFactory)
    {
    ...
    void injectConfig(final OpenTableJacksonConfig config)
    {
    ...
    @Inject(optional=true)
    void setSpecificSerializers(@Named(OpenTableObjectMapperBinder.JACKSON_NAME) final Set<Module> modules)
    {
        this.modules.addAll(modules);
    }

    @Inject(optional=true)
    void setOptions(@Named(OpenTableObjectMapperBinder.JACKSON_NAME) final Map<Enum<?>, Boolean> options)
    {
